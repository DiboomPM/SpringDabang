...
<!--                             <li>
                        ...
                        <ul>
                            <li>
                                <input type="text" class="type2 content" placeholder="이름" title="이름">
                            </li>
                            <li>
                                <input type="password" class="type2 content" placeholder="비밀번호" title="비밀번호">
                            </li>
                            <li>
                                <input type="password" class="type2 content" placeholder="비밀번호 확인" title="비밀번호 확인">
                            </li>
                            <li>
                                <input type="text" class="type2 content" placeholder="전화번호" title="전화번호">
                            </li>
                        </ul>

                        <div class="btns">
                            <ul>
                                <li><input type="submit" value="내정보 수정 완료" class="btn btn_yellow btn_submit"></li>
                                <li>
